...
vim.keymap.set({ 'n', 't' }, '<C-`>', toggle_terminal, { desc = 'Open terminal' })
vim.keymap.set({ 'n', 't' }, '<space>`', toggle_terminal, { desc = 'Open terminal' })
